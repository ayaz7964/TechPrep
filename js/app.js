...
var EMBEDDED = {
  categories: [
    ...
    { id: "cdn",         name: "CDN",                   icon: "\u26A1", color: "#00bcd4", description: "CDN fundamentals, edge servers, caching, optimization, and major providers" },
    { id: "traffic-management", name: "Traffic Management", icon: "\uD83D\uDD04", color: "#ff6b35", description: "Reverse proxy, load balancing, routing, failover, and traffic patterns" },
    { id: "api-gateway", name: "API Gateway",           icon: "\uD83C\uDFF7\uFE0F", color: "#7c3aed", description: "Gateway concepts, Kong, NGINX, Traefik, AWS API Gateway, and security" },
    { id: "monitoring",  name: "Monitoring",            icon: "\uD83D\uDCCA", color: "#ef4444", description: "Metrics, logging, tracing, alerting, Prometheus, Grafana, and observability" },
    { id: "logging",     name: "Logging",               icon: "\uD83D\uDCDD", color: "#10b981", description: "Centralized logging, structured logs, aggregation, rotation, and shipping" },
  ...
  topics: {
    ...
    cdn: [
      { id: "cdn-fundamentals", title: "CDN Fundamentals", difficulty: "beginner", estimatedMinutes: 20, file: "cdn-fundamentals.json" },
      { id: "cdn-edge-servers", title: "Edge Servers", difficulty: "beginner", estimatedMinutes: 15, file: "cdn-edge-servers.json" },
      { id: "cdn-edge-locations", title: "Edge Locations", difficulty: "beginner", estimatedMinutes: 15, file: "cdn-edge-locations.json" },
      { id: "cdn-origin-server", title: "Origin Server", difficulty: "beginner", estimatedMinutes: 15, file: "cdn-origin-server.json" },
      { id: "cdn-cache-hit", title: "Cache Hit", difficulty: "beginner", estimatedMinutes: 10, file: "cdn-cache-hit.json" },
      { id: "cdn-cache-miss", title: "Cache Miss", difficulty: "beginner", estimatedMinutes: 10, file: "cdn-cache-miss.json" },
      { id: "cdn-cache-invalidation", title: "Cache Invalidation", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-cache-invalidation.json" },
      { id: "cdn-cache-control-headers", title: "Cache-Control Headers", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-cache-control-headers.json" },
      { id: "cdn-ttl", title: "TTL (Time To Live)", difficulty: "beginner", estimatedMinutes: 15, file: "cdn-ttl.json" },
      { id: "cdn-dynamic-content", title: "Dynamic Content", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-dynamic-content.json" },
      { id: "cdn-static-content", title: "Static Content", difficulty: "beginner", estimatedMinutes: 10, file: "cdn-static-content.json" },
      { id: "cdn-image-optimization", title: "Image Optimization", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-image-optimization.json" },
      { id: "cdn-compression", title: "Compression", difficulty: "intermediate", estimatedMinutes: 15, file: "cdn-compression.json" },
      { id: "cdn-brotli", title: "Brotli", difficulty: "intermediate", estimatedMinutes: 15, file: "cdn-brotli.json" },
      { id: "cdn-gzip", title: "Gzip", difficulty: "beginner", estimatedMinutes: 10, file: "cdn-gzip.json" },
      { id: "cdn-http-2", title: "HTTP/2", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-http-2.json" },
      { id: "cdn-http-3", title: "HTTP/3", difficulty: "advanced", estimatedMinutes: 20, file: "cdn-http-3.json" },
      { id: "cdn-security", title: "CDN Security", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-security.json" },
      { id: "cdn-geo-routing", title: "Geo Routing", difficulty: "intermediate", estimatedMinutes: 15, file: "cdn-geo-routing.json" },
      { id: "cdn-geo-blocking", title: "Geo Blocking", difficulty: "intermediate", estimatedMinutes: 15, file: "cdn-geo-blocking.json" },
      { id: "cdn-ddos-protection", title: "DDoS Protection", difficulty: "advanced", estimatedMinutes: 25, file: "cdn-ddos-protection.json" },
      { id: "cdn-waf-integration", title: "WAF Integration", difficulty: "advanced", estimatedMinutes: 20, file: "cdn-waf-integration.json" },
      { id: "cdn-signed-urls", title: "Signed URLs", difficulty: "advanced", estimatedMinutes: 20, file: "cdn-signed-urls.json" },
      { id: "cdn-signed-cookies", title: "Signed Cookies", difficulty: "advanced", estimatedMinutes: 20, file: "cdn-signed-cookies.json" },
      { id: "cdn-cloudflare", title: "Cloudflare CDN", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-cloudflare.json" },
      { id: "cdn-aws-cloudfront", title: "AWS CloudFront", difficulty: "intermediate", estimatedMinutes: 25, file: "cdn-aws-cloudfront.json" },
      { id: "cdn-azure-cdn", title: "Azure CDN", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-azure-cdn.json" },
      { id: "cdn-google-cloud-cdn", title: "Google Cloud CDN", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-google-cloud-cdn.json" },
      { id: "cdn-fastly", title: "Fastly", difficulty: "intermediate", estimatedMinutes: 20, file: "cdn-fastly.json" },
      { id: "cdn-akamai", title: "Akamai", difficulty: "advanced", estimatedMinutes: 20, file: "cdn-akamai.json" }
    ],
    "traffic-management": [
      { id: "tm-reverse-proxy", title: "Reverse Proxy", difficulty: "intermediate", estimatedMinutes: 20, file: "tm-reverse-proxy.json" },
      { id: "tm-forward-proxy", title: "Forward Proxy", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-forward-proxy.json" },
      { id: "tm-api-gateway", title: "API Gateway", difficulty: "intermediate", estimatedMinutes: 20, file: "tm-api-gateway.json" },
      { id: "tm-load-balancing", title: "Load Balancing", difficulty: "intermediate", estimatedMinutes: 20, file: "tm-load-balancing.json" },
      { id: "tm-traffic-routing", title: "Traffic Routing", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-traffic-routing.json" },
      { id: "tm-path-routing", title: "Path Routing", difficulty: "beginner", estimatedMinutes: 10, file: "tm-path-routing.json" },
      { id: "tm-host-routing", title: "Host Routing", difficulty: "beginner", estimatedMinutes: 10, file: "tm-host-routing.json" },
      { id: "tm-dns-routing", title: "DNS Routing", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-dns-routing.json" },
      { id: "tm-geo-routing", title: "Geo Routing", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-geo-routing.json" },
      { id: "tm-traffic-splitting", title: "Traffic Splitting", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-traffic-splitting.json" },
      { id: "tm-canary-routing", title: "Canary Routing", difficulty: "advanced", estimatedMinutes: 20, file: "tm-canary-routing.json" },
      { id: "tm-blue-green-routing", title: "Blue Green Routing", difficulty: "advanced", estimatedMinutes: 20, file: "tm-blue-green-routing.json" },
      { id: "tm-session-affinity", title: "Session Affinity", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-session-affinity.json" },
      { id: "tm-sticky-sessions", title: "Sticky Sessions", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-sticky-sessions.json" },
      { id: "tm-circuit-breaker", title: "Circuit Breaker", difficulty: "advanced", estimatedMinutes: 20, file: "tm-circuit-breaker.json" },
      { id: "tm-retry-policies", title: "Retry Policies", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-retry-policies.json" },
      { id: "tm-failover", title: "Failover", difficulty: "advanced", estimatedMinutes: 20, file: "tm-failover.json" },
      { id: "tm-disaster-recovery", title: "Disaster Recovery", difficulty: "advanced", estimatedMinutes: 25, file: "tm-disaster-recovery.json" },
      { id: "tm-active-active", title: "Active-Active", difficulty: "advanced", estimatedMinutes: 20, file: "tm-active-active.json" },
      { id: "tm-active-passive", title: "Active-Passive", difficulty: "advanced", estimatedMinutes: 20, file: "tm-active-passive.json" },
      { id: "tm-health-checks", title: "Health Checks", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-health-checks.json" },
      { id: "tm-heartbeat", title: "Heartbeat", difficulty: "intermediate", estimatedMinutes: 10, file: "tm-heartbeat.json" },
      { id: "tm-latency-routing", title: "Latency Based Routing", difficulty: "advanced", estimatedMinutes: 15, file: "tm-latency-routing.json" },
      { id: "tm-weighted-routing", title: "Weighted Routing", difficulty: "intermediate", estimatedMinutes: 15, file: "tm-weighted-routing.json" }
    ],
    "api-gateway": [
      { id: "ag-kong", title: "Kong", difficulty: "intermediate", estimatedMinutes: 20, file: "ag-kong.json" },
      { id: "ag-nginx-gateway", title: "NGINX API Gateway", difficulty: "intermediate", estimatedMinutes: 20, file: "ag-nginx-gateway.json" },
      { id: "ag-ambassador", title: "Ambassador", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-ambassador.json" },
      { id: "ag-traefik", title: "Traefik", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-traefik.json" },
      { id: "ag-aws-api-gateway", title: "AWS API Gateway", difficulty: "intermediate", estimatedMinutes: 20, file: "ag-aws-api-gateway.json" },
      { id: "ag-rate-limiting", title: "Rate Limiting", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-rate-limiting.json" },
      { id: "ag-authentication", title: "Authentication", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-authentication.json" },
      { id: "ag-authorization", title: "Authorization", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-authorization.json" },
      { id: "ag-api-keys", title: "API Keys", difficulty: "beginner", estimatedMinutes: 10, file: "ag-api-keys.json" },
      { id: "ag-jwt-validation", title: "JWT Validation", difficulty: "intermediate", estimatedMinutes: 15, file: "ag-jwt-validation.json" },
      { id: "ag-oauth", title: "OAuth", difficulty: "advanced", estimatedMinutes: 20, file: "ag-oauth.json" },
      { id: "ag-logging", title: "Logging", difficulty: "beginner", estimatedMinutes: 10, file: "ag-logging.json" },
      { id: "ag-metrics", title: "Metrics", difficulty: "beginner", estimatedMinutes: 10, file: "ag-metrics.json" }
    ],
    monitoring: [
      { id: "mon-fundamentals", title: "Monitoring Fundamentals", difficulty: "beginner", estimatedMinutes: 15, file: "mon-fundamentals.json" },
      { id: "mon-metrics", title: "Metrics", difficulty: "beginner", estimatedMinutes: 15, file: "mon-metrics.json" },
      { id: "mon-logging", title: "Logging", difficulty: "beginner", estimatedMinutes: 10, file: "mon-logging.json" },
      { id: "mon-tracing", title: "Tracing", difficulty: "intermediate", estimatedMinutes: 20, file: "mon-tracing.json" },
      { id: "mon-alerting", title: "Alerting", difficulty: "intermediate", estimatedMinutes: 15, file: "mon-alerting.json" },
      { id: "mon-dashboards", title: "Dashboards", difficulty: "beginner", estimatedMinutes: 10, file: "mon-dashboards.json" },
      { id: "mon-prometheus", title: "Prometheus", difficulty: "intermediate", estimatedMinutes: 25, file: "mon-prometheus.json" },
      { id: "mon-grafana", title: "Grafana", difficulty: "intermediate", estimatedMinutes: 20, file: "mon-grafana.json" },
      { id: "mon-loki", title: "Loki", difficulty: "intermediate", estimatedMinutes: 15, file: "mon-loki.json" },
      { id: "mon-elasticsearch", title: "Elasticsearch", difficulty: "intermediate", estimatedMinutes: 20, file: "mon-elasticsearch.json" },
      { id: "mon-kibana", title: "Kibana", difficulty: "intermediate", estimatedMinutes: 15, file: "mon-kibana.json" },
      { id: "mon-fluentd", title: "Fluentd", difficulty: "intermediate", estimatedMinutes: 15, file: "mon-fluentd.json" },
      { id: "mon-fluent-bit", title: "Fluent Bit", difficulty: "intermediate", estimatedMinutes: 15, file: "mon-fluent-bit.json" },
      { id: "mon-jaeger", title: "Jaeger", difficulty: "advanced", estimatedMinutes: 20, file: "mon-jaeger.json" },
      { id: "mon-zipkin", title: "Zipkin", difficulty: "advanced", estimatedMinutes: 20, file: "mon-zipkin.json" },
      { id: "mon-opentelemetry", title: "OpenTelemetry", difficulty: "advanced", estimatedMinutes: 25, file: "mon-opentelemetry.json" }
    ],
    logging: [
      { id: "log-centralized", title: "Centralized Logging", difficulty: "intermediate", estimatedMinutes: 15, file: "log-centralized.json" },
      { id: "log-structured", title: "Structured Logging", difficulty: "intermediate", estimatedMinutes: 15, file: "log-structured.json" },
      { id: "log-aggregation", title: "Log Aggregation", difficulty: "intermediate", estimatedMinutes: 15, file: "log-aggregation.json" },
      { id: "log-rotation", title: "Log Rotation", difficulty: "beginner", estimatedMinutes: 10, file: "log-rotation.json" },
      { id: "log-levels", title: "Log Levels", difficulty: "beginner", estimatedMinutes: 10, file: "log-levels.json" },
      { id: "log-shipping", title: "Log Shipping", difficulty: "intermediate", estimatedMinutes: 15, file: "log-shipping.json" }
    ],
    mern: [
      { id: "mern-architecture", title: "MERN Architecture", difficulty: "intermediate", estimatedMinutes: 20, file: "mern-architecture.json" },
      { id: "mern-setup", title: "MERN Stack Setup", difficulty: "beginner", estimatedMinutes: 15, file: "mern-setup.json" },
      { id: "mern-rest-api", title: "REST API with MERN", difficulty: "intermediate", estimatedMinutes: 25, file: "mern-rest-api.json" },
      { id: "mern-authentication", title: "MERN Authentication", difficulty: "intermediate", estimatedMinutes: 20, file: "mern-authentication.json" },
      { id: "mern-file-upload", title: "File Upload in MERN", difficulty: "intermediate", estimatedMinutes: 15, file: "mern-file-upload.json" },
      { id: "mern-deployment", title: "MERN Deployment", difficulty: "advanced", estimatedMinutes: 20, file: "mern-deployment.json" },
      { id: "mern-state-management", title: "MERN State Management", difficulty: "intermediate", estimatedMinutes: 20, file: "mern-state-management.json" },
      { id: "mern-real-time", title: "Real-Time with Socket.io", difficulty: "intermediate", estimatedMinutes: 20, file: "mern-real-time.json" },
      { id: "mern-testing", title: "MERN Testing", difficulty: "advanced", estimatedMinutes: 20, file: "mern-testing.json" },
      { id: "mern-performance", title: "MERN Performance", difficulty: "advanced", estimatedMinutes: 15, file: "mern-performance.json" },
      { id: "mern-security", title: "MERN Security", difficulty: "advanced", estimatedMinutes: 20, file: "mern-security.json" },
      { id: "mern-graphql", title: "MERN + GraphQL", difficulty: "advanced", estimatedMinutes: 25, file: "mern-graphql.json" },
      { id: "mern-docker", title: "MERN with Docker", difficulty: "intermediate", estimatedMinutes: 20, file: "mern-docker.json" },
      { id: "mern-ci-cd", title: "MERN CI/CD Pipeline", difficulty: "advanced", estimatedMinutes: 20, file: "mern-ci-cd.json" },
      { id: "mern-monitoring", title: "MERN Monitoring", difficulty: "intermediate", estimatedMinutes: 15, file: "mern-monitoring.json" }
    ],
    "system-design": [
      { id: "sd-interview", title: "System Design Interview", difficulty: "advanced", estimatedMinutes: 30, file: "sd-interview.json" },
      { id: "sd-scalability", title: "Scalability", difficulty: "advanced", estimatedMinutes: 25, file: "sd-scalability.json" },
      { id: "sd-microservices", title: "Microservices Architecture", difficulty: "advanced", estimatedMinutes: 25, file: "sd-microservices.json" },
      { id: "sd-monolithic", title: "Monolithic Architecture", difficulty: "intermediate", estimatedMinutes: 15, file: "sd-monolithic.json" },
      { id: "sd-load-balancing", title: "Load Balancing", difficulty: "intermediate", estimatedMinutes: 20, file: "sd-load-balancing.json" },
      { id: "sd-caching", title: "Caching Strategies", difficulty: "intermediate", estimatedMinutes: 20, file: "sd-caching.json" },
      { id: "sd-database-sharding", title: "Database Sharding", difficulty: "advanced", estimatedMinutes: 25, file: "sd-database-sharding.json" },
      { id: "sd-database-replication", title: "Database Replication", difficulty: "intermediate", estimatedMinutes: 20, file: "sd-database-replication.json" },
      { id: "sd-cdn", title: "Content Delivery Network", difficulty: "intermediate", estimatedMinutes: 15, file: "sd-cdn.json" },
      { id: "sd-message-queues", title: "Message Queues", difficulty: "intermediate", estimatedMinutes: 20, file: "sd-message-queues.json" },
      { id: "sd-event-driven", title: "Event-Driven Architecture", difficulty: "advanced", estimatedMinutes: 20, file: "sd-event-driven.json" },
      { id: "sd-cap-theorem", title: "CAP Theorem", difficulty: "advanced", estimatedMinutes: 15, file: "sd-cap-theorem.json" },
      { id: "sd-consistency-patterns", title: "Consistency Patterns", difficulty: "advanced", estimatedMinutes: 20, file: "sd-consistency-patterns.json" },
      { id: "sd-bloom-filters", title: "Bloom Filters", difficulty: "advanced", estimatedMinutes: 15, file: "sd-bloom-filters.json" },
      { id: "sd-consistent-hashing", title: "Consistent Hashing", difficulty: "advanced", estimatedMinutes: 20, file: "sd-consistent-hashing.json" },
      { id: "sd-rate-limiting", title: "Rate Limiting", difficulty: "intermediate", estimatedMinutes: 15, file: "sd-rate-limiting.json" },
      { id: "sd-circuit-breaker", title: "Circuit Breaker Pattern", difficulty: "advanced", estimatedMinutes: 15, file: "sd-circuit-breaker.json" },
      { id: "sd-leader-election", title: "Leader Election", difficulty: "advanced", estimatedMinutes: 15, file: "sd-leader-election.json" },
      { id: "sd-distributed-transactions", title: "Distributed Transactions", difficulty: "advanced", estimatedMinutes: 25, file: "sd-distributed-transactions.json" },
      { id: "sd-id-generation", title: "ID Generation", difficulty: "intermediate", estimatedMinutes: 15, file: "sd-id-generation.json" },
      { id: "sd-url-shortener", title: "Design URL Shortener", difficulty: "advanced", estimatedMinutes: 20, file: "sd-url-shortener.json" },
      { id: "sd-pastebin", title: "Design Pastebin", difficulty: "advanced", estimatedMinutes: 20, file: "sd-pastebin.json" },
      { id: "sd-chat-system", title: "Design Chat System", difficulty: "advanced", estimatedMinutes: 25, file: "sd-chat-system.json" },
      { id: "sd-design-twitter", title: "Design Twitter Feed", difficulty: "advanced", estimatedMinutes: 30, file: "sd-design-twitter.json" }
    ],
    devops: [
      { id: "devops-culture", title: "DevOps Culture", difficulty: "beginner", estimatedMinutes: 15, file: "devops-culture.json" },
      { id: "devops-cloud-computing", title: "Cloud Computing", difficulty: "beginner", estimatedMinutes: 15, file: "devops-cloud-computing.json" },
      { id: "devops-aws-ec2", title: "AWS EC2", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-aws-ec2.json" },
      { id: "devops-aws-s3", title: "AWS S3", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-aws-s3.json" },
      { id: "devops-aws-lambda", title: "AWS Lambda", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-aws-lambda.json" },
      { id: "devops-aws-vpc", title: "AWS VPC", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-aws-vpc.json" },
      { id: "devops-iac", title: "Infrastructure as Code", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-iac.json" },
      { id: "devops-terraform", title: "Terraform", difficulty: "intermediate", estimatedMinutes: 25, file: "devops-terraform.json" },
      { id: "devops-cloudformation", title: "CloudFormation", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-cloudformation.json" },
      { id: "devops-ansible", title: "Ansible", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-ansible.json" },
      { id: "devops-puppet", title: "Puppet", difficulty: "intermediate", estimatedMinutes: 15, file: "devops-puppet.json" },
      { id: "devops-chef", title: "Chef", difficulty: "intermediate", estimatedMinutes: 15, file: "devops-chef.json" },
      { id: "devops-config-mgmt", title: "Configuration Management", difficulty: "intermediate", estimatedMinutes: 15, file: "devops-config-mgmt.json" },
      { id: "devops-containerization", title: "Containerization", difficulty: "intermediate", estimatedMinutes: 20, file: "devops-containerization.json" },
      { id: "devops-orchestration", title: "Orchestration", difficulty: "advanced", estimatedMinutes: 20, file: "devops-orchestration.json" },
      { id: "devops-cloud-migration", title: "Cloud Migration", difficulty: "advanced", estimatedMinutes: 20, file: "devops-cloud-migration.json" },
      { id: "devops-hybrid-cloud", title: "Hybrid Cloud", difficulty: "advanced", estimatedMinutes: 20, file: "devops-hybrid-cloud.json" },
      { id: "devops-multi-cloud", title: "Multi-Cloud Strategy", difficulty: "advanced", estimatedMinutes: 20, file: "devops-multi-cloud.json" },
      { id: "devops-cost-optimization", title: "Cloud Cost Optimization", difficulty: "intermediate", estimatedMinutes: 15, file: "devops-cost-optimization.json" },
      { id: "devops-cloud-security", title: "Cloud Security", difficulty: "advanced", estimatedMinutes: 20, file: "devops-cloud-security.json" }
    ],
    git: [
      { id: "git-workflow", title: "Git Workflows", difficulty: "intermediate", estimatedMinutes: 20, file: "git-workflow.json" },
      { id: "git-branching", title: "Branching Strategies", difficulty: "intermediate", estimatedMinutes: 20, file: "git-branching.json" },
      { id: "git-merge", title: "Git Merge", difficulty: "intermediate", estimatedMinutes: 15, file: "git-merge.json" },
      { id: "git-rebase", title: "Git Rebase", difficulty: "intermediate", estimatedMinutes: 20, file: "git-rebase.json" },
      { id: "git-stash", title: "Git Stash", difficulty: "beginner", estimatedMinutes: 10, file: "git-stash.json" },
      { id: "git-tag", title: "Git Tags", difficulty: "beginner", estimatedMinutes: 10, file: "git-tag.json" },
      { id: "git-submodule", title: "Git Submodules", difficulty: "intermediate", estimatedMinutes: 15, file: "git-submodule.json" },
      { id: "git-hooks", title: "Git Hooks", difficulty: "intermediate", estimatedMinutes: 15, file: "git-hooks.json" },
      { id: "git-bisect", title: "Git Bisect", difficulty: "advanced", estimatedMinutes: 15, file: "git-bisect.json" },
      { id: "git-revert", title: "Git Revert", difficulty: "intermediate", estimatedMinutes: 10, file: "git-revert.json" },
      { id: "git-reset", title: "Git Reset", difficulty: "intermediate", estimatedMinutes: 15, file: "git-reset.json" },
      { id: "git-cherry-pick", title: "Git Cherry-Pick", difficulty: "intermediate", estimatedMinutes: 15, file: "git-cherry-pick.json" },
      { id: "git-pull-request", title: "Pull Requests", difficulty: "beginner", estimatedMinutes: 15, file: "git-pull-request.json" },
      { id: "git-code-review", title: "Code Review", difficulty: "intermediate", estimatedMinutes: 15, file: "git-code-review.json" },
      { id: "git-ci-cd-pipeline", title: "CI/CD Pipeline", difficulty: "intermediate", estimatedMinutes: 20, file: "git-ci-cd-pipeline.json" },
      { id: "git-ci-cd-tools", title: "CI/CD Tools", difficulty: "intermediate", estimatedMinutes: 15, file: "git-ci-cd-tools.json" },
      { id: "git-build-automation", title: "Build Automation", difficulty: "intermediate", estimatedMinutes: 20, file: "git-build-automation.json" },
      { id: "git-test-automation", title: "Test Automation", difficulty: "intermediate", estimatedMinutes: 20, file: "git-test-automation.json" },
      { id: "git-deployment-automation", title: "Deployment Automation", difficulty: "advanced", estimatedMinutes: 20, file: "git-deployment-automation.json" },
      { id: "git-release-mgmt", title: "Release Management", difficulty: "intermediate", estimatedMinutes: 15, file: "git-release-mgmt.json" }
    ],
    dsa: [
      { id: "dsa-arrays", title: "Arrays", difficulty: "beginner", estimatedMinutes: 20, file: "dsa-arrays.json" },
      { id: "dsa-linked-lists", title: "Linked Lists", difficulty: "beginner", estimatedMinutes: 20, file: "dsa-linked-lists.json" },
      { id: "dsa-stacks", title: "Stacks", difficulty: "beginner", estimatedMinutes: 15, file: "dsa-stacks.json" },
      { id: "dsa-queues", title: "Queues", difficulty: "beginner", estimatedMinutes: 15, file: "dsa-queues.json" },
      { id: "dsa-hash-tables", title: "Hash Tables", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-hash-tables.json" },
      { id: "dsa-trees", title: "Trees", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-trees.json" },
      { id: "dsa-binary-trees", title: "Binary Trees", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-binary-trees.json" },
      { id: "dsa-bst", title: "Binary Search Trees", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-bst.json" },
      { id: "dsa-heaps", title: "Heaps", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-heaps.json" },
      { id: "dsa-graphs", title: "Graphs", difficulty: "advanced", estimatedMinutes: 25, file: "dsa-graphs.json" },
      { id: "dsa-dfs", title: "DFS (Depth-First Search)", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-dfs.json" },
      { id: "dsa-bfs", title: "BFS (Breadth-First Search)", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-bfs.json" },
      { id: "dsa-dynamic-programming", title: "Dynamic Programming", difficulty: "advanced", estimatedMinutes: 30, file: "dsa-dynamic-programming.json" },
      { id: "dsa-recursion", title: "Recursion", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-recursion.json" },
      { id: "dsa-backtracking", title: "Backtracking", difficulty: "advanced", estimatedMinutes: 25, file: "dsa-backtracking.json" },
      { id: "dsa-greedy", title: "Greedy Algorithms", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-greedy.json" },
      { id: "dsa-divide-conquer", title: "Divide and Conquer", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-divide-conquer.json" },
      { id: "dsa-sorting", title: "Sorting Algorithms", difficulty: "intermediate", estimatedMinutes: 20, file: "dsa-sorting.json" },
      { id: "dsa-searching", title: "Searching Algorithms", difficulty: "intermediate", estimatedMinutes: 15, file: "dsa-searching.json" },
      { id: "dsa-two-pointers", title: "Two Pointers", difficulty: "intermediate", estimatedMinutes: 15, file: "dsa-two-pointers.json" },
      { id: "dsa-sliding-window", title: "Sliding Window", difficulty: "intermediate", estimatedMinutes: 15, file: "dsa-sliding-window.json" },
      { id: "dsa-prefix-sum", title: "Prefix Sum", difficulty: "intermediate", estimatedMinutes: 10, file: "dsa-prefix-sum.json" },
      { id: "dsa-bit-manipulation", title: "Bit Manipulation", difficulty: "advanced", estimatedMinutes: 20, file: "dsa-bit-manipulation.json" },
      { id: "dsa-trie", title: "Trie", difficulty: "advanced", estimatedMinutes: 20, file: "dsa-trie.json" },
      { id: "dsa-union-find", title: "Union Find", difficulty: "advanced", estimatedMinutes: 20, file: "dsa-union-find.json" },
      { id: "dsa-topological-sort", title: "Topological Sort", difficulty: "advanced", estimatedMinutes: 15, file: "dsa-topological-sort.json" },
      { id: "dsa-shortest-path", title: "Shortest Path", difficulty: "advanced", estimatedMinutes: 20, file: "dsa-shortest-path.json" },
      { id: "dsa-min-spanning-tree", title: "Minimum Spanning Tree", difficulty: "advanced", estimatedMinutes: 15, file: "dsa-min-spanning-tree.json" },
      { id: "dsa-string-matching", title: "String Matching", difficulty: "advanced", estimatedMinutes: 20, file: "dsa-string-matching.json" },
      { id: "dsa-time-complexity", title: "Time Complexity", difficulty: "beginner", estimatedMinutes: 15, file: "dsa-time-complexity.json" }
    ],
    oop: [
      { id: "oop-basics", title: "OOP Basics", difficulty: "beginner", estimatedMinutes: 15, file: "oop-basics.json" },
      { id: "oop-encapsulation", title: "Encapsulation", difficulty: "beginner", estimatedMinutes: 15, file: "oop-encapsulation.json" },
      { id: "oop-inheritance", title: "Inheritance", difficulty: "beginner", estimatedMinutes: 15, file: "oop-inheritance.json" },
      { id: "oop-polymorphism", title: "Polymorphism", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-polymorphism.json" },
      { id: "oop-abstraction", title: "Abstraction", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-abstraction.json" },
      { id: "oop-solid", title: "SOLID Principles", difficulty: "intermediate", estimatedMinutes: 20, file: "oop-solid.json" },
      { id: "oop-single-responsibility", title: "Single Responsibility", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-single-responsibility.json" },
      { id: "oop-open-closed", title: "Open-Closed Principle", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-open-closed.json" },
      { id: "oop-liskov", title: "Liskov Substitution", difficulty: "advanced", estimatedMinutes: 15, file: "oop-liskov.json" },
      { id: "oop-interface-segregation", title: "Interface Segregation", difficulty: "advanced", estimatedMinutes: 15, file: "oop-interface-segregation.json" },
      { id: "oop-dependency-inversion", title: "Dependency Inversion", difficulty: "advanced", estimatedMinutes: 15, file: "oop-dependency-inversion.json" },
      { id: "oop-design-patterns", title: "Design Patterns", difficulty: "intermediate", estimatedMinutes: 20, file: "oop-design-patterns.json" },
      { id: "oop-singleton", title: "Singleton Pattern", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-singleton.json" },
      { id: "oop-factory", title: "Factory Pattern", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-factory.json" },
      { id: "oop-observer", title: "Observer Pattern", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-observer.json" },
      { id: "oop-strategy", title: "Strategy Pattern", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-strategy.json" },
      { id: "oop-decorator", title: "Decorator Pattern", difficulty: "intermediate", estimatedMinutes: 15, file: "oop-decorator.json" },
