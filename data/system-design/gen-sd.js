...
R(10,45,160,32,'#0070f3','','Client','Users')+
A(170,61,200,61)+
R(210,45,100,32,'#28a745','','Load Balancer','Nginx/ELB')+
A(310,61,340,61)+A(260,77,60,83)+
R(10,85,100,32,'#ffc107','','App Servers','Stateless')+
A(110,101,150,101)+
R(150,85,100,32,'#dc3545','','Cache','Redis/Memc')+
A(200,117,200,123)+
R(10,125,100,32,'#e83e8c','','DB','Primary')+
A(110,141,150,141)+
R(150,125,100,32,'#6610f2','','Replica','Read-only')+
R(10,160,100,32,'#17a2b8','','CDN','Static assets')+
R(10,178,480,52,'#17a2b8','','System Design') + Tw(250,203,'Requirements → High-level → Deep dive → Wrap-up. Estimate QPS, storage, bandwidth. Discuss trade-offs.',9,'#666','middle',85)+T(240,255,'System Design Interview: Structured 4-step framework. Estimate scale, discuss trade-offs.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Users','1M DAU')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','CDN','Static cache')+
A(200,77,190,83)+
R(10,85,100,32,'#ffc107','','Load Balancer','Distribute')+
A(110,101,150,101)+
R(150,85,80,32,'#dc3545','','App','Server 1')+
R(240,85,80,32,'#dc3545','','App','Server N')+
A(200,117,200,123)+
R(10,125,100,32,'#e83e8c','','Cache','Redis/Memc')+
A(110,141,150,141)+
R(150,125,80,32,'#6610f2','','DB','Primary')+
R(240,125,80,32,'#6610f2','','DB','Replica')+
R(10,178,480,52,'#17a2b8','','Scalability') + Tw(250,203,'Horizontal > Vertical. Stateless apps. Cache, CDN, sharding, replicas, auto-scaling.',9,'#666','middle',85)+T(240,255,'Scalability: Ability to handle growing load. Horizontal > Vertical. Stateless, cache, shard, auto-scale.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','App/Mobile')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','API Gateway','Entry point')+
A(200,77,200,83)+
R(10,85,80,32,'#ffc107','','Service','Users')+
R(100,85,80,32,'#dc3545','','Service','Orders')+
R(190,85,80,32,'#e83e8c','','Service','Payments')+
R(280,85,80,32,'#6610f2','','Service','Inventory')+
R(10,125,100,32,'#17a2b8','','DB per Service','Decoupled')+
A(60,157,40,163)+R(10,160,60,32,'#6f42c1','','Queue','Kafka')+
R(10,178,480,52,'#17a2b8','','Microservices') + Tw(250,203,'Small, independent services. DB-per-service. Async communication. Saga for transactions.',9,'#666','middle',85)+T(240,255,'Microservices: Independently deployable services with their own databases. Async communication, Saga pattern.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','HTTP request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Monolith App','Single process')+
A(200,77,60,83)+
R(10,85,100,32,'#ffc107','','Controller','Route request')+
A(110,101,150,101)+
R(150,85,100,32,'#dc3545','','Service','Business logic')+
A(200,117,60,123)+
R(10,125,100,32,'#e83e8c','','Repository','Data access')+
A(110,141,150,141)+
R(150,125,100,32,'#6610f2','','PostgreSQL','Single DB')+
R(10,178,480,52,'#17a2b8','','Monolith') + Tw(250,203,'Single codebase + DB + deploy unit. Simple dev, horizontal scale limited. Extract services when team grows.',9,'#666','middle',85)+T(240,255,'Monolithic Architecture: Single deployable unit. Simple dev but scales as one piece. Extract services when needed.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Load Balancer','Distribute')+
A(200,77,140,83)+
R(10,85,80,32,'#ffc107','','Server','Instance 1')+
R(100,85,80,32,'#dc3545','','Server','Instance 2')+
R(190,85,80,32,'#e83e8c','','Server','Instance N')+
R(10,125,100,32,'#6610f2','','Health Check','/health')+
R(150,125,100,32,'#17a2b8','','Algorithm','RR/LC/IP Hash')+
R(10,178,480,52,'#17a2b8','','Load Balancing') + Tw(250,203,'L4 (TCP) or L7 (HTTP). RR, LC, IP Hash. Health checks, draining. Stateless design preferred over sticky sessions.',9,'#666','middle',85)+T(240,255,'Load Balancing: Distribute traffic across servers. L4/L7, RR/LC algorithms, health checks.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Cache Check','Key exists?')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','Cache HIT','Return cached')+
R(160,85,100,32,'#dc3545','','Cache MISS','Query DB')+
A(160,117,160,123)+
R(160,125,100,32,'#e83e8c','','Database','Storage')+
A(210,157,210,163)+
R(160,160,100,32,'#6610f2','','Populate','Cache + Return')+
R(10,178,480,52,'#17a2b8','','Caching') + Tw(250,203,'Cache-Aside: check → miss → DB → populate. TTL, LRU. Redis. Target >80% hit rate.',9,'#666','middle',85)+T(240,255,'Caching: Store hot data in fast layer. Cache-Aside pattern. TTL, LRU, Redis. Target >80% hit rate.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Proxy/Driver','Route by shard key')+
A(200,77,140,83)+
R(10,85,80,32,'#ffc107','','Shard 1','Users A-M')+
R(100,85,80,32,'#dc3545','','Shard 2','Users N-Z')+
R(190,85,80,32,'#e83e8c','','Shard N','Range/Hash')+
R(10,125,100,32,'#6610f2','','Config Map','Shard key→Shard')+
R(150,125,100,32,'#17a2b8','','Shard Key','hash(id) % N')+
R(10,178,480,52,'#17a2b8','','Sharding') + Tw(250,203,'Horizontal partitioning by shard key. Hash-based or range. Consistent hashing for resharding. Avoid cross-shard.',9,'#666','middle',85)+T(240,255,'Sharding: Partition data across DB instances by shard key. Hash for distribution, consistent hashing for resharding.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Writes')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Primary','Read+Write')+
A(200,77,170,83)+
R(10,85,100,32,'#ffc107','','Replica 1','Read-only')+
R(120,85,100,32,'#dc3545','','Replica 2','Read-only')+
R(230,85,100,32,'#e83e8c','','Replica N','Read-only')+
R(10,125,100,32,'#6610f2','','WAL Stream','Async/Sync')+
R(10,178,480,52,'#17a2b8','','Replication') + Tw(250,203,'Primary → Replicas. Read scaling, HA, failover. Async (fast) vs Sync (consistent). Monitor lag.',9,'#666','middle',85)+T(240,255,'Replication: Copy data from primary to replicas. Scale reads, failover. Sync vs async.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','User','Browser')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','DNS','Nearest edge')+
A(200,77,60,83)+
R(10,85,100,32,'#ffc107','','Edge Server','Cache check')+
A(110,101,150,101)+
R(150,85,80,32,'#dc3545','','HIT','Return')+
R(240,85,80,32,'#e83e8c','','MISS','Fetch origin')+
R(10,125,100,32,'#6610f2','','Origin','S3/Server')+
R(150,125,100,32,'#17a2b8','','CDN PoP','Global edge')+
R(10,178,480,52,'#17a2b8','','CDN') + Tw(250,203,'Distributed edge servers. Cache static, reduce latency, absorb traffic, DDoS protection.',9,'#666','middle',85)+T(240,255,'CDN: Deliver content from nearest edge server. Reduce latency, offload origin, DDoS protection.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Producer','Service A')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Queue/Broker','RabbitMQ/Kafka')+
A(200,77,170,83)+
R(10,85,100,32,'#ffc107','','Consumer 1','Service X')+
R(120,85,100,32,'#dc3545','','Consumer 2','Service Y')+
R(230,85,100,32,'#e83e8c','','DLQ','Failed msgs')+
R(10,125,100,32,'#6610f2','','Exchange','Routing')+
R(150,125,100,32,'#17a2b8','','Partition','Ordered log')+
R(10,178,480,52,'#17a2b8','','Message Queue') + Tw(250,203,'Async decoupling. RabbitMQ (routing) vs Kafka (streaming). At-least-once, idempotent, DLQ.',9,'#666','middle',85)+T(240,255,'Message Queues: Async decoupling. RabbitMQ for routing, Kafka for streaming. DLQ, idempotent consumers.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Producer','Service A')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Event Bus','Kafka/EventBridge')+
A(200,77,140,83)+
R(10,85,80,32,'#ffc107','','Consumer','Service X')+
R(100,85,80,32,'#dc3545','','Consumer','Service Y')+
R(190,85,80,32,'#e83e8c','','Consumer','Service Z')+
R(10,125,100,32,'#6610f2','','Event Store','Persist all events')+
R(150,125,100,32,'#17a2b8','','Event Stream','Ordered log')+
R(10,178,480,52,'#17a2b8','','Event-Driven') + Tw(250,203,'Producers → Event Bus → Consumers. Loose coupling, eventual consistency. Event Sourcing + CQRS.',9,'#666','middle',85)+T(240,255,'Event-Driven: Producers publish events to bus. Consumers react. Loose coupling, eventual consistency, event sourcing.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','CP','HBase, ZK, etcd')+
R(10,85,100,32,'#28a745','','Consistent','+ Partition')+
R(10,125,100,32,'#ffc107','','Use for','Config, metadata')+
R(160,45,100,32,'#dc3545','','AP','Cassandra, Dynamo')+
R(160,85,100,32,'#e83e8c','','Available','+ Partition')+
R(160,125,100,32,'#6610f2','','Use for','User-facing, geo')+
R(10,178,480,52,'#17a2b8','','CAP Theorem') + Tw(250,203,'Pick CP or AP (P is required). CP: consistent, blocked during partition. AP: always available, eventual consistency.',9,'#666','middle',85)+T(240,255,'CAP Theorem: Choose CP (Consistency) or AP (Availability). P is required in distributed systems.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Write','Client')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Leader','Primary')+
A(200,77,140,83)+
R(10,85,80,32,'#ffc107','','Sync Repl','Strong')+
R(100,85,80,32,'#dc3545','','Async Repl','Eventual')+
R(10,125,100,32,'#e83e8c','','Quorum','W+R > N')+
R(150,125,100,32,'#6610f2','','Read','Client')+
R(10,178,480,52,'#17a2b8','','Consistency Patterns') + Tw(250,203,'Strong (linearizable) vs Eventual. Quorum, Raft, CRDTs. Choose by business need: financial=strong, feeds=eventual.',9,'#666','middle',85)+T(240,255,'Consistency: Strong (linearizable) vs Eventual. Quorum, Raft consensus. Choose by business requirements.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Element x','Test')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Bloom Filter','M bits, K hashes')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','All bits 1?','Maybe present')+
R(160,85,100,32,'#dc3545','','Any bit 0?','Definitely NOT')+
R(10,125,100,32,'#e83e8c','','Hash 1','pos=42')+
R(10,150,100,32,'#6610f2','','Hash K','pos=17')+
R(160,125,100,32,'#17a2b8','','Return quickly','No DB hit')+
R(10,178,480,52,'#17a2b8','','Bloom Filter') + Tw(250,203,'Probabilistic membership. No false negatives, FP possible. M bits, K hashes. Cache penetration prevention.',9,'#666','middle',85)+T(240,255,'Bloom Filter: Space-efficient membership test. No false negatives, FP possible. Cache penetration prevention.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Node A','hash(A)=100')+
R(120,45,100,32,'#28a745','','Node B','hash(B)=300')+
R(230,45,100,32,'#dc3545','','Node C','hash(C)=500')+
A(100,61,120,61)+A(200,61,230,61)+
R(10,85,100,32,'#ffc107','','Key X','hash(X)=200')+
A(55,83,55,95)+
R(120,85,100,32,'#e83e8c','','Key Y','hash(Y)=450')+
A(165,83,165,95)+
R(10,125,100,32,'#6610f2','','Ring','0 → 2^32-1')+
R(120,125,100,32,'#17a2b8','','VNodes','Multiple per node')+
R(10,178,480,52,'#17a2b8','','Consistent Hashing') + Tw(250,203,'Ring-based hashing. Only 1/N keys move on node change. VNodes for distribution. Used in Cassandra, DynamoDB, CDNs.',9,'#666','middle',85)+T(240,255,'Consistent Hashing: Ring-based hashing minimizes data movement on node changes. VNodes for even distribution.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Rate Limiter','Token Bucket')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','Has Token?','Allow')+
R(160,85,100,32,'#dc3545','','No Token','429 Retry-After')+
R(10,125,100,32,'#e83e8c','','Redis','Atomic Lua')+
R(160,125,100,32,'#6610f2','','Backend','Protected')+
R(10,178,480,52,'#17a2b8','','Rate Limiting') + Tw(250,203,'Token Bucket/Sliding Window. Redis+Lua. 429+Retry-After. Fail open. Tiered limits.',9,'#666','middle',85)+T(240,255,'Rate Limiting: Control request frequency. Token Bucket algorithm. Redis atomic. 429 with Retry-After.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','CLOSED','Normal')+
A(110,61,150,61)+A(40,65,40,95)+
R(150,45,100,32,'#28a745','','Call service','Pass through')+
R(10,85,100,32,'#ffc107','','Failure > N','Trip!')+
R(10,125,100,32,'#dc3545','','OPEN','Fail fast')+
A(55,120,55,145)+
R(150,125,100,32,'#e83e8c','','Fallback','Cache/default')+
R(10,160,100,32,'#6610f2','','Timeout','Try test')+
R(150,160,100,32,'#17a2b8','','HALF-OPEN','Test call')+
R(10,178,480,52,'#17a2b8','','Circuit Breaker') + Tw(250,203,'CLOSED→OPEN (failures) → HALF-OPEN (test) → CLOSED(ok)/OPEN(fail). Fallback, bulkhead.',9,'#666','middle',85)+T(240,255,'Circuit Breaker: Prevent cascading failures. Three states, fallback, bulkhead isolation.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Follower','Node 1')+
R(120,45,100,32,'#28a745','','Follower','Node 2')+
R(230,45,100,32,'#dc3545','','Leader','Node 3')+
A(200,61,230,61)+
R(10,85,100,32,'#ffc107','','Heartbeat','Leader→All')+
R(120,85,100,32,'#e83e8c','','Timeout!','No heartbeat')+
A(120,117,120,123)+
R(120,125,100,32,'#6610f2','','Election','Vote request')+
R(230,125,100,32,'#17a2b8','','New Leader','Majority wins')+
R(10,178,480,52,'#17a2b8','','Leader Election') + Tw(250,203,'Raft: terms, randomized elections, heartbeats. Prevent split-brain with quorum and fencing.',9,'#666','middle',85)+T(240,255,'Leader Election: Designate one coordinator. Raft consensus, heartbeats, split-brain prevention.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Request')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','Saga Coordinator','Orchestrator')+
A(200,77,140,83)+
R(10,85,80,32,'#ffc107','','Step 1','Order')+
R(100,85,80,32,'#dc3545','','Step 2','Payment')+
R(190,85,80,32,'#e83e8c','','Step 3','Shipping')+
R(10,125,100,32,'#6610f2','','Compensation','Rollback')+
R(150,125,100,32,'#17a2b8','','Event Bus','Choreography')+
R(10,178,480,52,'#17a2b8','','Distributed Transactions') + Tw(250,203,'2PC (blocking) vs Saga (eventual consistency). Idempotency, compensating transactions, outbox pattern.',9,'#666','middle',85)+T(240,255,'Distributed Transactions: 2PC (strong, blocking) vs Saga (eventual, compensating). Idempotent operations.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Unique','No duplicates')+
R(10,65,100,32,'#28a745','','Sortable','DB-friendly')+
R(10,95,100,32,'#ffc107','','Decentralized','No bottleneck')+
R(10,125,100,32,'#dc3545','','Compact','Storage efficient')+
R(160,45,60,32,'#e83e8c','','UUID','128-bit')+
R(230,45,60,32,'#6610f2','','Snowflake','64-bit')+
R(160,65,60,32,'#17a2b8','','ULID','128-bit sort')+
R(230,65,60,32,'#6f42c1','','NanoID','Short crypto')+
R(10,178,480,52,'#17a2b8','','ID Generation') + Tw(250,203,'UUID v7 (sortable), Snowflake (64-bit), ULID, NanoID. Choose by requirements: sortability, size, decentralization.',9,'#666','middle',85)+T(240,255,'ID Generation: UUID v7, Snowflake, ULID, NanoID. Sortable IDs improve DB index performance.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','POST /shorten')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','App Server','Generate key')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','KGS','Get unique key')+
R(160,85,100,32,'#dc3545','','Cache','Redis store')+
A(60,117,60,123)+R(10,125,100,32,'#e83e8c','','DB','DynamoDB')+
R(160,125,100,32,'#6610f2','','Redirect','301 to long URL')+
R(10,178,480,52,'#17a2b8','','URL Shortener') + Tw(250,203,'Base62 encode + KGS. 301 redirect, Redis cache, DynamoDB. Analytics via Kafka.',9,'#666','middle',85)+T(240,255,'URL Shortener: Base62 short codes, 301/302 redirect. Redis cache, DynamoDB. KGS for key generation.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client','Create/View')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','App Server','API')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','Generate ID','Base62')+
R(160,85,100,32,'#dc3545','','S3 Storage','Compressed')+
R(10,125,100,32,'#e83e8c','','DB (Dynamo)','Metadata')+
R(160,125,100,32,'#6610f2','','Cache (Redis)','Hot pastes')+
R(10,178,480,52,'#17a2b8','','Pastebin') + Tw(250,203,'Object storage for content. Syntax highlighting, expiry, burn-after-read. Rate-limited creation.',9,'#666','middle',85)+T(240,255,'Pastebin: Object storage for content, syntax highlighting, expiry, burn-after-read.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','Client A','WebSocket')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','WS LB','HAProxy')+
A(200,77,200,83)+
R(10,85,100,32,'#ffc107','','Chat Service','Validate+Store')+
A(110,101,150,101)+A(60,117,60,123)+
R(150,85,100,32,'#dc3545','','Message Queue','Kafka/SQS')+
R(10,125,100,32,'#e83e8c','','DB','Cassandra')+

R(150,125,100,32,'#6610f2','','Push Notification','FCM/APNS')+
R(10,160,100,32,'#17a2b8','','Redis','Presence+Pub/Sub')+
R(10,178,480,52,'#17a2b8','','Chat System') + Tw(250,203,'WebSocket real-time. Fan-out on write (groups). Cassandra storage. Redis presence. Push notifications.',9,'#666','middle',85)+T(240,255,'Chat System: WebSocket real-time messaging. Fan-out: write (small groups) or read (large channels). Presence, push, E2EE.',9,'#666','middle'),
[
...
R(10,45,100,32,'#0070f3','','User','Post tweet')+
A(110,61,150,61)+
R(150,45,100,32,'#28a745','','API Gateway','Validate')+
A(200,77,210,83)+
R(10,85,100,32,'#ffc107','','Tweet Service','Store tweet')+
R(160,85,100,32,'#dc3545','','Fan-out Worker','Push to followers')+
R(10,125,100,32,'#e83e8c','','DB + Cache','Tweets')+
R(160,125,100,32,'#6610f2','','Timeline Cache','Redis sorted set')+
R(10,160,100,32,'#17a2b8','','Search Index','Elasticsearch')+
R(10,178,480,52,'#17a2b8','','Twitter Feed') + Tw(250,203,'Hybrid PUSH/PULL. Redis sorted sets for timeline. Async fan-out. Trending via Spark batch.',9,'#666','middle',85)+T(240,255,'Twitter Feed: Hybrid PUSH/PULL. Redis timeline cache, async fan-out, trending batch processing.',9,'#666','middle'),
[
